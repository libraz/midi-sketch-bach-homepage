...
const softwareApplicationJsonLd = {
  ...
  keywords:
    'Bach MIDI generator, algorithmic composition, Baroque MIDI, fugue generator, invention generator, chorale generator, counterpoint, instrumental MIDI, バッハ MIDI生成, アルゴリズム作曲, 対位法',
}
    ...
    head: [
      ...
      [
        'meta',
        {
          name: 'keywords',
          content:
            'Bach MIDI generator, algorithmic composition, Baroque MIDI, fugue generator, invention generator, chorale generator, counterpoint MIDI, instrumental MIDI, classical music generator, music theory, Bach style, harpsichord MIDI, organ MIDI, バッハ MIDI生成, アルゴリズム作曲, バロック音楽, フーガ生成, インヴェンション, コラール, 対位法, 器楽曲MIDI, クラシック音楽, DTM',
        },
      ],
      ...
      [
        ...
        {
          property: 'og:title',
          content: 'MIDI Sketch Bach - Algorithmic Bach Instrumental MIDI Generator',
        },
      ],
      [
        'meta',
      ...
      [
        'meta',
        {
          ...
          content:
            'Generate Bach-style instrumental MIDI using algorithmic composition. Editable MIDI data for your DAW, not finished audio.',
        },
      ],
