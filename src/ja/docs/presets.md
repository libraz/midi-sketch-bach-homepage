---
title: プリセットリファレンス
description: MIDI Sketch Bachのすべてのフォーム、楽器、キャラクター、スケール、調の完全なリファレンステーブル。
---
...
::: tip
これらの関数はドロップダウンやフォームセレクターなどのUIコンポーネントの構築に便利です。このサイトのデモではフォーム選択インターフェースの入力にこれらを使用しています。
:::
