...
export const formConstraintExamples: Record<string, StaffExampleDef> = {
  ...
  anacrusisUpbeat: {
    ...
    lower: [{ key: 'd/3', duration: 'h', rest: true }, { key: 'c/3' }, { key: 'g/2' }],
    issues: [
  ...
  impliedStreams: {
    ...
    issues: [
      ...
      {
        kind: 'motion',
        label: 'the bass your ear extracts',
        fromLower: 0,
        toLower: 1,
        color: AMBER,
      },
  ...
  trioIndependence: {
    ...
    upper: [{ key: 'c/5', duration: 'h', color: GREEN }, { key: 'b/4' }, { key: 'c/5' }],
    middle: [
      { key: 'e/4', color: GREEN },
      { key: 'f/4', color: GREEN },
      { key: 'g/4', color: GREEN },
  ...
  arpeggioContrary: {
    ...
    lower: [{ key: 'c/3' }, { key: 'd/3', color: GREEN }, { key: 'e/3', color: GREEN }],
    issues: [
      {
        kind: 'motion',
        label: 'contrary streams',
        fromUpper: 0,
        toUpper: 2,
        fromLower: 0,
        toLower: 2,
